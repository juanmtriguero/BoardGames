...
<display:table name="promotions" id="row" requestURI="/event/auth/list.do" pagesize="5" class="displaytag">
...
<display:table name="tournaments" id="row" requestURI="/event/auth/list.do" pagesize="5" class="displaytag">
