...
<form:form action="event/business/editPromotion.do" modelAttribute="promotionEditForm">
	...
	<fieldset>
		<legend><spring:message code="event.form.sponsorship" /></legend>
		<br />
		<acme:textbox code="event.form.sponsorName" path="sponsorName" />
		<acme:textbox code="event.form.sponsorLogo" path="sponsorLogo" />
		<acme:textbox code="event.form.sponsorPayment" path="sponsorPayment" />
	</fieldset>
	<br />
